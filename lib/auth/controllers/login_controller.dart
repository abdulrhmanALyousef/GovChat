  ...
  Future<void> login(BuildContext context) async {
    ...
    try {
      ...
      if (!empDoc.exists) {
        ...
        errorMessage = l.mobileEmployeeOnly;
        isLoading = false;
        notifyListeners();
        return;
      }
      ...
      // ── OTP 2FA ───────────────────────────────────────────────────────
      // Legacy employees (no phoneNumber or phoneVerified != true) bypass OTP.
      // New employees with a verified phone number require OTP on every login.
